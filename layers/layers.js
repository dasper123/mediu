...
//ol.proj.get("EPSG:3844").setExtent([577870.164171, 336154.455190, 580188.750542, 337553.659990]);
var wms_layers = [];
...
var format_tabel_v1_0206_2 = new ol.format.GeoJSON();
var features_tabel_v1_0206_2 = format_tabel_v1_0206_2.readFeatures(json_tabel_v1_0206_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3844'});
var jsonSource_tabel_v1_0206_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_tabel_v1_0206_2.addFeatures(features_tabel_v1_0206_2);
var lyr_tabel_v1_0206_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_tabel_v1_0206_2, 
                style: style_tabel_v1_0206_2,
                popuplayertitle: 'tabel_v1_02.06',
                interactive: true,
                title: '<img src="styles/legend/tabel_v1_0206_2.png" /> tabel_v1_02.06'
            });

lyr_GoogleHybrid_0.setVisible(true);lyr_tabel_v1_10_06_1.setVisible(true);lyr_tabel_v1_0206_2.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_tabel_v1_10_06_1,lyr_tabel_v1_0206_2];
...
lyr_tabel_v1_0206_2.set('fieldImages', {'ie': 'Range', 'suprafata': 'Range', 'siruta': 'Range', 'id': 'TextEdit', 'general_ta': 'TextEdit', 'general__1': 'TextEdit', 'general__2': 'TextEdit', 'general__3': 'TextEdit', 'general__4': 'TextEdit', 'general__5': 'TextEdit', 'general__6': 'TextEdit', 'general__7': 'TextEdit', 'general__8': 'TextEdit', 'general__9': 'TextEdit', 'general_10': 'TextEdit', 'general_11': 'TextEdit', 'general_12': 'TextEdit', 'general_13': 'TextEdit', 'general_14': 'TextEdit', 'general_15': 'TextEdit', 'general_16': 'TextEdit', 'general_17': 'TextEdit', 'general_18': 'TextEdit', 'general_19': 'TextEdit', 'general_20': 'TextEdit', 'general_21': 'TextEdit', 'general_22': 'TextEdit', 'general_23': 'TextEdit', 'general_24': 'TextEdit', 'general_25': 'TextEdit', });
...
lyr_tabel_v1_0206_2.set('fieldLabels', {'ie': 'no label', 'suprafata': 'no label', 'siruta': 'no label', 'id': 'no label', 'general_ta': 'no label', 'general__1': 'no label', 'general__2': 'no label', 'general__3': 'no label', 'general__4': 'no label', 'general__5': 'no label', 'general__6': 'no label', 'general__7': 'no label', 'general__8': 'no label', 'general__9': 'no label', 'general_10': 'no label', 'general_11': 'no label', 'general_12': 'no label', 'general_13': 'no label', 'general_14': 'no label', 'general_15': 'no label', 'general_16': 'no label', 'general_17': 'no label', 'general_18': 'no label', 'general_19': 'no label', 'general_20': 'no label', 'general_21': 'no label', 'general_22': 'no label', 'general_23': 'no label', 'general_24': 'no label', 'general_25': 'no label', });
lyr_tabel_v1_0206_2.on('precompose', function(evt) {
